var MENU = {
  tabs: [
    { id: '2-x-de-martes-a-sabado-hasta-las-22-30', label: "2 X DE MARTES A SABADO HASTA LAS 22 HRS" },
    ...
    { id: 'cocteleria-clasica', label: "COCTELERIA SIN ALCOHOL Y CERVEZAS" },
  ...
  items: {
    ...
    "juegos": [
      { name: "CURAO, VOLAO O WEON", desc: "El juego se prestara a mesa que lo solicite a costo 0, sin embargo, si este presenta algún tipo de daño al ser retirado, se cobrara un valor de 20.000 pesos, lo mismo pasara si llegase a faltar alguna pieza de este. Curao, Volao o Weoón es un party game diseñado para disfrutar con amigos. En cada turno, un jugador actúa como juez y lee una carta en voz alta. Luego, los participantes acusan a otro de encajar con la descripción de la carta, basándose en personalidad o anécdotas. El juez escucha las acusaciones y decide a quién asignar la carta. Aquellos que acumulen 7 cartas pierden en este juego donde no hay ganadores, solo perdedores.", price: "", img: "707021_1776380863.webp", tags: [] },
      { name: "BASTA", desc: "El juego se prestara a mesa que lo solicite a costo 0, sin embargo, si este presenta algún tipo de daño al ser retirado, se cobrara un valor de 20.000 pesos, lo mismo pasara si llegase a faltar alguna pieza de este. El objetivo del juego es simple pero cautivador: los jugadores deben completar categorías con palabras que comiencen con una letra específica. Esto no solo pone a prueba el conocimiento general, sino que también desafía la rapidez mental y la capacidad de pensar de manera creativa. Cada partida es única, lo que garantiza horas de entretenimiento y risas.", price: "", img: "707027_1776380944.webp", tags: [] },
      { name: "CHUPILCA", desc: "El juego se prestara a mesa que lo solicite a costo 0, sin embargo, si este presenta algún tipo de daño al ser retirado, se cobrara un valor de 10.000 pesos, lo mismo pasara si llegase a faltar alguna pieza de este.", price: "", img: "707030_1776381048.webp", tags: [] },
      { name: "PALTA BORRACHA", desc: "El juego se prestara a mesa que lo solicite a costo 0, sin embargo, si este presenta algún tipo de daño al ser retirado, se cobrara un valor de 10.000 pesos, lo mismo pasara si llegase a faltar alguna pieza de este.", price: "", img: "707033_1776381187.webp", tags: [] },
      { name: "CARTAS INGLESA", desc: "El juego se prestara a mesa que lo solicite a costo 0, sin embargo, si este presenta algún tipo de daño al ser retirado, se cobrara un valor de 10.000 pesos, lo mismo pasara si llegase a faltar alguna pieza de este.", price: "", img: "707037_1776381327.webp", tags: [] },
      { name: "CARTA ESPAÑOLA", desc: "El juego se prestara a mesa que lo solicite a costo 0, sin embargo, si este presenta algún tipo de daño al ser retirado, se cobrara un valor de 10.000 pesos, lo mismo pasara si llegase a faltar alguna pieza de este.", price: "", img: "707039_1776381380.webp", tags: [] },
      { name: "CARTA UNO", desc: "El juego se prestara a mesa que lo solicite a costo 0, sin embargo, si este presenta algún tipo de daño al ser retirado, se cobrara un valor de 10.000 pesos, lo mismo pasara si llegase a faltar alguna pieza de este.", price: "", img: "707042_1776381534.webp", tags: [] },
      { name: "BACHILLERATO", desc: "El juego se prestara a mesa que lo solicite a costo 0, sin embargo, si este presenta algún tipo de daño al ser retirado, se cobrara un valor de 20.000 pesos, lo mismo pasara si llegase a faltar alguna pieza de este.", price: "", img: "709691_1776810840.webp", tags: [] },
      { name: "RULETA DEL BEBER", desc: "El juego se prestara a mesa que lo solicite a costo 0, sin embargo, si este presenta algún tipo de daño al ser retirado, se cobrara un valor de 20.000 pesos, lo mismo pasara si llegase a faltar alguna pieza de este", price: "", img: "709693_1776810897.webp", tags: [] },
      { name: "MANTA DE POLAR", desc: "Las mantas se prestara a mesa que lo solicite a costo 0, sin embargo, si este presenta algún tipo de daño al ser retirado, se cobrara un valor de 10.000 pesos.", price: "", img: "709696_1776811066.webp", tags: [] }
    ],
    "bebidas-y-jugos": [
